...
/// ```
/// use factoriod_config::MapGenSizeFloat;
...
/// ```
/// use factoriod_config::{MapGenSizeFloat, MapGenSizeFloatError};
...
pub enum MapGenSize {
    ...
    /// ```
    /// use factoriod_config::MapGenSize;
    ...
    /// ```
    /// use factoriod_config::{MapGenSize, MapGenSizeFloat};
